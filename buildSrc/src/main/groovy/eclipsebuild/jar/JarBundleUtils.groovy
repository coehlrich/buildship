...
class JarBundleUtils {
    ...
    private static ResolvedArtifact findSourceArtifact(Project project, Configuration configuration) {
        System.err.println(configuration.resolvedConfiguration.resolvedArtifacts)
    }
